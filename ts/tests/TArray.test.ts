...
describe("OArrayType", (): void => {
	...
	values.set("", TStandard.string);
	values.set(42, TStandard.number);
	values.set(true, TStandard.boolean);
	values.set(null, TStandard.null);
	values.set(undefined, TStandard.undefined);
